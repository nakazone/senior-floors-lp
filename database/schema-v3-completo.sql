-- ============================================
-- Senior Floors CRM - Schema Completo v3.0
...
-- ============================================
-- TABELA 3: PROJETOS (Obras) - ATUALIZADA COM PÓS-ATENDIMENTO
-- ============================================
CREATE TABLE IF NOT EXISTS `projects` (
  ...
  INDEX `idx_post_service_status` (`post_service_status`),
  INDEX `idx_project_status_dates` (`status`, `estimated_start_date`),
...
CREATE TABLE IF NOT EXISTS `activities` (
  ...
  INDEX `idx_activity_customer_date` (`customer_id`, `activity_date`),
