 ...
 * Install app: https://ntfy.sh — subscribe to the same topic you set in LEAD_NTFY_TOPIC.
 * Use a long random topic string (it acts like a shared secret on the public server).
 */
